...
const WC_ASSETS = {
  styles: [
    { id: "wc-ui-kit", href: "/static/css/ui-kit.css" },
    {
      id: "wc-swal2-style",
...
const AssetLoader = (() => {
  ...
  const injectScript = ({ id, src }) => {
    if (!src || injectedScripts.has(src) || (id && document.getElementById(id)))
      return;
  ...
  const load = () => {
    ...
    WC_ASSETS.styles.forEach(injectStyle);
    WC_ASSETS.scripts.forEach(injectScript);
  };
...
const AlertManager = (() => {
  ...
  const ensureSwal = () => (typeof Swal !== "undefined" ? Swal : null);
  ...
  const confirm = async (message, options = {}) => {
    ...
    const result = await swal.fire({
      ...
      reverseButtons: true,
      focusCancel: true,
      customClass: { popup: "wc-alert-modal" },
    });
...
function showNotification(message, type = "info") {
  AlertManager.notify(message, type);
}
...
async function confirmAction(message, options = {}) {
  return AlertManager.confirm(message, options);
}

// Prompt helper
async function requestInput(options = {}) {
  return AlertManager.prompt(options);
}
...
const BUSINESS_PALETTES = {
  artesanias: [
    {
      id: "artesanias-arcilla",
      label: "Arcilla dorada",
      primary: "#CBB67C",
      secondary: "#8B5E3C",
      accent: "#FAF4ED",
      background: "#FBF7F0",
    ...
    {
      id: "artesanias-terracota",
      label: "Terracota viva",
      primary: "#A0522D",
      secondary: "#E1A95F",
      accent: "#D8B4A0",
      background: "#F1E4C6",
  ...
  adecuaciones: [
    ...
    {
      id: "adecuaciones-industrial",
      label: "Industrial nocturno",
      primary: "#003049",
      secondary: "#EAE2B7",
      accent: "#F4BA00",
      background: "#FAF4ED",
    ...
    {
      id: "adecuaciones-marina",
      label: "Marina moderna",
      primary: "#1D3557",
      secondary: "#457B9D",
      accent: "#A8DADC",
      background: "#F1FAEE",
    ...
    {
      id: "adecuaciones-contraste",
      label: "Contraste profesional",
      primary: "#003566",
      secondary: "#FFC300",
      accent: "#E5E5E5",
      background: "#1C1C1C",
  ...
  belleza: [
    ...
    {
      id: "belleza-editorial",
      label: "Editorial lila",
      primary: "#6A1B9A",
      secondary: "#BA68C8",
      accent: "#F3E5F5",
      background: "#F7F7F7",
...
function findPaletteForModel(modelId, paletteId) {
  return (BUSINESS_PALETTES[modelId] || []).find(
